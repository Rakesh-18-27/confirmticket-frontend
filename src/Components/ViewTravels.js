...
const ViewTravels = (props) => {
  ...
  const handleDestinationSuggestion = () => {
    ...
    axios
      .get(
        `http://localhost:2022/get-all-routes-by-location/${source.current.value}/${destination.current.value}`
      )
      .then(
        (p) => {
          const { data } = p;
      ...
      .then(
        (p) => {
          ...
          if (data != null) {
            getTravels();
            setBookedSeats([]);
            document.getElementById(`alert${busId}`).style.display = `flex`;
          }
          setTimeout(() => {
            document.getElementById(`alert${busId}`).style.display = `none`;
          }, 2000);
        },
        (e) => {
          console.log(e);
        ...
        <div className="row mt-3 justify-content-center align-items-center p-3">
          <div className={`col-md-3 ${props.width < 520 ? `mt-3` : ``}`}>
            <label
              htmlFor="source"
              className={`${
                props.mode == `dark` ? `gradient-text1` : `gradient-text`
              } form-label nun`}
            >
              Source
            </label>
            <input
              ...
              style={{
                ...
                borderBottom: `1px solid ${
                  props.mode == `dark` ? `lightblue` : `darkblue`
                }`,
              }}
          ...
          <div className={`col-md-3 ${props.width < 520 ? `mt-3` : ``}`}>
            ...
            <div
              ...
              style={{
                ...
                border: "1px solid black",
                display: `${
                  destinationSuggestions.length > 0 ? "block" : "none"
                }`,
                position: "absolute",
                width: `${props.width > 400 ? `20%` : `80%`}`,
                backgroundColor: "#fff",
            ...
            >
              {destinationSuggestions.map((suggestion, index) => (
                <div
                  onClick={() => getDestination(suggestion)}
                  key={index}
                  className="suggestion-item"
                >
                  {suggestion}
                        ...
                        <tr>
                          ...
                          >
                            <div
                              ...
                              style={{display:`none`}}
                            >
                              <i className="fa fa-check-circle-o"></i>Tickets Booked Successfully
                              <button
                                type="button"
                                class="btn-close"
